...
// Device tracking tables have been removed from the core schema in this branch
// to eliminate the device-tracking feature from the application. If you need
// device tracking in a future release reintroduce the tables and related
// relations in the schema and migration scripts.
